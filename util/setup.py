...
def load_args():
    ...
    parser.add_argument('-config', '--config', default=None, type=str,
        help='Config name')
    parser.add_argument('-dataset_dir', '--ddir', type=str, default="./datasets/PEMSD7",
        help='Path to dataset')
    parser.add_argument('-dataset_name', '--dname', type=str, default="PEMSD7",
    ...
    parser.add_argument('-device', '--device', default='cpu', type=str,
        help='GPU to enable (default: cpu)')
